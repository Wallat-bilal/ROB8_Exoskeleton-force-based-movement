...
class Metaclass_Move_Goal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('epos_action_node')
        except ImportError:
            import logging
            import traceback
...
class Move_Feedback(metaclass=Metaclass_Move_Feedback):
    ...
    _fields_and_field_types = {
        'partial_sequences': 'sequence<int32>',
    }
    ...
    def __init__(self, **kwargs):
        assert all('_' + key in self.__slots__ for key in kwargs.keys()), \
            'Invalid arguments passed to constructor: %s' % \
            ', '.join(sorted(k for k in kwargs.keys() if '_' + k not in self.__slots__))
        self.partial_sequences = array.array('i', kwargs.get('partial_sequences', []))
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.partial_sequences != other.partial_sequences:
            return False
        return True
    ...
    @builtins.property
    def partial_sequences(self):
        """Message field 'partial_sequences'."""
        return self._partial_sequences

    @partial_sequences.setter
    def partial_sequences(self, value):
        if isinstance(value, array.array):
            assert value.typecode == 'i', \
                "The 'partial_sequences' array.array() must have the type code of 'i'"
            self._partial_sequences = value
            return
        if __debug__:
            from collections.abc import Sequence
            from collections.abc import Set
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, int) for v in value) and
                 all(val >= -2147483648 and val < 2147483648 for val in value)), \
                "The 'partial_sequences' field must be a set or sequence and each value of type 'int' and each integer in [-2147483648, 2147483647]"
        self._partial_sequences = array.array('i', value)
...
class Metaclass_Move_SendGoal_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from epos_action_node.action import Move
...
class Move_SendGoal_Request(metaclass=Metaclass_Move_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'epos_action_node/Move_Goal',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['epos_action_node', 'action'], 'Move_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from epos_action_node.action._move import Move_Goal
...
class Metaclass_Move_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'epos_action_node.action.Move_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from epos_action_node.action import _move
...
class Move_SendGoal(metaclass=Metaclass_Move_SendGoal):
    from epos_action_node.action._move import Move_SendGoal_Request as Request
    from epos_action_node.action._move import Move_SendGoal_Response as Response
...
class Move_GetResult_Response(metaclass=Metaclass_Move_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'epos_action_node/Move_Result',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('int8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['epos_action_node', 'action'], 'Move_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from epos_action_node.action._move import Move_Result
...
class Metaclass_Move_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'epos_action_node.action.Move_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Move_GetResult(metaclass=Metaclass_Move_GetResult):
    from epos_action_node.action._move import Move_GetResult_Request as Request
    from epos_action_node.action._move import Move_GetResult_Response as Response
...
class Metaclass_Move_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'epos_action_node.action.Move_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Move_FeedbackMessage(metaclass=Metaclass_Move_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'epos_action_node/Move_Feedback',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['epos_action_node', 'action'], 'Move_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from epos_action_node.action._move import Move_Feedback
...
class Move(metaclass=Metaclass_Move):
    ...
    from epos_action_node.action._move import Move_Goal as Goal
    # The result message defined in the action definition.
    from epos_action_node.action._move import Move_Result as Result
    # The feedback message defined in the action definition.
    from epos_action_node.action._move import Move_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from epos_action_node.action._move import Move_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from epos_action_node.action._move import Move_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from epos_action_node.action._move import Move_FeedbackMessage as FeedbackMessage
